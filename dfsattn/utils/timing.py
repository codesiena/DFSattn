...
class AttentionTimingRecorder:
    ...
    def dump_csv(
        ...
        detailed_phases = (
            ...
            "flashinfer_residual_rode_plan",
            "flashinfer_residual_rode_fp32",
            "flashinfer_residual_rode_sddmm",
            "flashinfer_residual_rode_softmax",
            "flashinfer_residual_rode_spmm",
            "flashinfer_residual_rode_run",
