...
def dfs_attention(
    ...
    flashinfer64_residual_min_top_k: int = 20,
    flashinfer64_residual_max_top_k: int = 32,
    ...
    if sparse_execution == "flashinfer64":
        ...
        output = backend(
            ...
            residual_min_top_k=flashinfer64_residual_min_top_k,
            residual_max_top_k=flashinfer64_residual_max_top_k,
